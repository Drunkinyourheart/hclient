...
//                Object result = readMethod.invoke(bean, new Object[0]);
                String result = readMethod.invoke(bean, new Object[0]).toString();
                if (result != null) {
    ...
    public static void main(String[] args) throws IllegalAccessException, IntrospectionException, InvocationTargetException, InstantiationException {
        ...
        System.out.println("map : " + convertBean2Map(a));

        Map<String, String> mm = convertBean2Map(a);

        System.out.println("aa : " + convertMap(A.class, mm));
